...
package object pingpong8resp {
  ...
  @verify(property = "no_output_use(c2a)()", spec_name = "pingpong8resp",
  ...
  def pingpongCHK1(c1a: ChanA,  c1b: ChanB,
                   ...
                   c6a: ChanA,  c6b: ChanB,
                   c7a: ChanA,  c7b: ChanB,
                   c8a: ChanA,  c8b: ChanB): PingPongSys[c1a.type,  c1b.type,
                                                         c2a.type,  c2b.type,
                                                         c3a.type,  c3b.type,
                                                         c4a.type,  c4b.type,
                                                         c5a.type,  c5b.type,
  ...
  @verify(property = "deadlock_free()", spec_name = "pingpong8resp",
  ...
  @verify(property = "eventual_output_use(c1a)()", spec_name = "pingpong8resp",
          benchmark = 10, big_lts = true)
  ...
  @verify(property = "forwarding(c1a)(c1b)", spec_name = "pingpong8resp",
  ...
  @verify(property = "reactive(c5a)()", spec_name = "pingpong8resp",
          benchmark = 10, big_lts = true, solver = pbes2bool_depth)
  ...
  @verify(property = "responsive(c2a)()", spec_name = "pingpong8resp",
          benchmark = 10, big_lts = true, solver = pbes2bool_depth)
