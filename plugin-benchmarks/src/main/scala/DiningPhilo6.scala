...
package object diningphilo6 {
  ...
  type Dining[C1pick <: Chan[Unit], C1drop <: Chan[Unit],
    ...
    Par12[ Philo[C6pick, C6drop, C1pick, C1drop],
           Fork[C1pick, C1drop],
  ...
  @verify(property = "no_output_use(p1)()", spec_name = "dining6",
  ...
  @verify(property = "deadlock_free()", spec_name = "dining6",
  ...
  @verify(property = "eventual_output_use(p1)()", spec_name = "dining6",
          benchmark = 10, big_lts = true)
  ...
  @verify(property = "forwarding(p1)(p2)", spec_name = "dining6",
  ...
  @verify(property = "reactive(p1)()", spec_name = "dining6",
          benchmark = 10, big_lts = true, solver = pbes2bool_depth)
  ...
  @verify(property = "responsive(p1)()", spec_name = "dining6",
          benchmark = 10, big_lts = true, solver = pbes2bool_depth)
