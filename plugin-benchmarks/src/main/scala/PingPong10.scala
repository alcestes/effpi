...
/** Ping-pong (10 pairs, non-responsive) verification benchmark. */
package object pingpong10 {
  import effpi.plugin.benchmarks.pingpong6.{ChanT, PingPong, PingPongSys}
  ...
  @verify(property = "no_output_use(c2a)()", spec_name = "pingpong10",
  ...
  def pingpongCHK1(c1a: ChanT,  c1b: ChanT,
                   ...
                   c8a: ChanT,  c8b: ChanT,
                   c9a: ChanT,  c9b: ChanT,
                   c10a: ChanT, c10b: ChanT): PingPongSys[c1a.type,  c1b.type,
                                                          c2a.type,  c2b.type,
                                                          c3a.type,  c3b.type,
                                                          c4a.type,  c4b.type,
                                                          c5a.type,  c5b.type,
  ...
  @verify(property = "deadlock_free()", spec_name = "pingpong10",
  ...
  @verify(property = "eventual_output_use(c1a)()", spec_name = "pingpong10",
          benchmark = 10, big_lts = true)
  ...
  @verify(property = "forwarding(c1a)(c1b)", spec_name = "pingpong10",
  ...
  @verify(property = "reactive(c5a)()", spec_name = "pingpong10",
          benchmark = 10, big_lts = true, solver = pbes2bool_depth)
  ...
  @verify(property = "responsive(c2a)()", spec_name = "pingpong10",
          benchmark = 10, big_lts = true, solver = pbes2bool_depth)
