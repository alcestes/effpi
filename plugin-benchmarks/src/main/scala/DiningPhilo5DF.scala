...
package object diningphilo5df {
  ...
  type Dining[C1pick <: Chan[Unit], C1drop <: Chan[Unit],
    ...
    Par10[ Philo[C1pick, C1drop, C5pick, C5drop],
           Fork[C1pick, C1drop],
  ...
  @verify(property = "no_output_use(p1)()", spec_name = "dining5_df",
  ...
  def diningCHK4(p1: Chan[Unit], d1: Chan[Unit],
                 ...
                 p5: Chan[Unit], d5: Chan[Unit]): Dining[p1.type, d1.type,
                                                         p2.type, d2.type,
                                                         p3.type, d3.type,
                                                         p4.type, d4.type,
                                                         p5.type, d5.type] = ???

  @verify(property = "deadlock_free()", spec_name = "dining5_df",
  ...
  @verify(property = "eventual_output_use(p1)()", spec_name = "dining5_df",
          benchmark = 10, big_lts = true)
  ...
  @verify(property = "forwarding(p1)(p2)", spec_name = "dining5_df",
  ...
  @verify(property = "reactive(p1)()", spec_name = "dining5_df",
          benchmark = 10, big_lts = true, solver = pbes2bool_depth)
  ...
  @verify(property = "responsive(p1)()", spec_name = "dining5_df",
          benchmark = 10, big_lts = true, solver = pbes2bool_depth)
