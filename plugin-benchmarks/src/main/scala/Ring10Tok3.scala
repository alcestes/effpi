...
package object ring10tok3 {
  ...
  @verify(property = "no_output_use(c1)()", spec_name = "ring10tok3",
  ...
  @verify(property = "deadlock_free()", spec_name = "ring10tok3",
          benchmark = 10, big_lts = false)
  def ringCHK2(c1: ChanT,  c2: ChanT,  c3: ChanT,  c4: ChanT,  c5: ChanT,
               c6: ChanT,  c7: ChanT,  c8: ChanT,  c9: ChanT,  c10: ChanT): Ring[c1.type,  c2.type,  c3.type,  c4.type,  c5.type,
                                                                                 c6.type,  c7.type,  c8.type,  c9.type,  c10.type] = ???

  @verify(property = "eventual_output_use(c1)()", spec_name = "ring10tok3",
          benchmark = 10, big_lts = true)
  def ringCHK3(c1: ChanT,  c2: ChanT,  c3: ChanT,  c4: ChanT,  c5: ChanT,
               c6: ChanT,  c7: ChanT,  c8: ChanT,  c9: ChanT,  c10: ChanT): Ring[c1.type,  c2.type,  c3.type,  c4.type,  c5.type,
                                                                                 c6.type,  c7.type,  c8.type,  c9.type,  c10.type] = ???

  @verify(property = "forwarding(c1)(c2)", spec_name = "ring10tok3",
  ...
  @verify(property = "reactive(c1)()", spec_name = "ring10tok3",
          benchmark = 10, big_lts = true, solver = pbessolve)
  ...
  @verify(property = "responsive(c1)()", spec_name = "ring10tok3",
