...
/** Simplified rendering of payment service with auditor, and 12 clients. */
package object payaudit12 {
  ...
  type PaymentSys[PayChan <: Chan[OChan[Result]],
                  ...
                  AudChan <: Chan[String]] = (
    Par3[ Par12[ Client[PayChan, RespChan],
  ...
  @verify(property = "no_output_use(pay)()", spec_name = "payaudit12",
  ...
  @verify(property = "deadlock_free()", spec_name = "payaudit12",
  ...
  @verify(property = "eventual_output_use(res)()", spec_name = "payaudit12",
          benchmark = 10, big_lts = true)
  ...
  @verify(property = "forwarding(pay)(res)", spec_name = "payaudit12",
  ...
  @verify(property = "reactive(pay)()", spec_name = "payaudit12",
          benchmark = 10, big_lts = true, solver = pbes2bool_depth)
  ...
  @verify(property = "responsive(pay)()", spec_name = "payaudit12",
          benchmark = 10, big_lts = true, solver = pbes2bool_depth)
