...
package object diningphilo5 {
  ...
  type Dining[C1pick <: Chan[Unit], C1drop <: Chan[Unit],
    ...
    Par10[ Philo[C5pick, C5drop, C1pick, C1drop],
           Fork[C1pick, C1drop],
  ...
  @verify(property = "no_output_use(p1)()", spec_name = "dining5",
  ...
  @verify(property = "deadlock_free()", spec_name = "dining5",
  ...
  @verify(property = "eventual_output_use(p1)()", spec_name = "dining5",
          benchmark = 10, big_lts = true)
  ...
  @verify(property = "forwarding(p1)(p2)", spec_name = "dining5",
  ...
  @verify(property = "reactive(p1)()", spec_name = "dining5",
          benchmark = 10, big_lts = true, solver = pbes2bool_depth)
  ...
  @verify(property = "responsive(p1)()", spec_name = "dining5",
          benchmark = 10, big_lts = true, solver = pbes2bool_depth)
