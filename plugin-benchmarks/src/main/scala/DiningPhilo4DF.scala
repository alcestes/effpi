...
package object diningphilo4df {
  ...
  type Dining[C1pick <: Chan[Unit], C1drop <: Chan[Unit],
    ...
    Par8[ Philo[C1pick, C1drop, C4pick, C4drop],
          Fork[C1pick, C1drop],
  ...
  @verify(property = "no_output_use(p1)()", spec_name = "dining4_df",
  ...
  @verify(property = "deadlock_free()", spec_name = "dining4_df",
  ...
  @verify(property = "eventual_output_use(p1)()", spec_name = "dining4_df",
          benchmark = 10, big_lts = true)
  ...
  @verify(property = "forwarding(p1)(p2)", spec_name = "dining4_df",
  ...
  @verify(property = "reactive(p1)()", spec_name = "dining4_df",
          benchmark = 10, big_lts = true, solver = pbes2bool_depth)
  ...
  @verify(property = "responsive(p1)()", spec_name = "dining4_df",
          benchmark = 10, big_lts = true, solver = pbes2bool_depth)
